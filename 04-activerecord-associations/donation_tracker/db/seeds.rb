...
Donation.create(amount: 200.00, date: 10/31/21, completed: false)


Donation.create(amount: 200.00, date: "10/31/21", completed: false, organization: feeding_america, donor: Donor.create(name: "Jerrod"))

Donation.create(amount: 200.00, date: "10/31/21", completed: false, organization_id: 3)
